#ifndef PARTICLE_SYSTEMSSEFMA_H_
#define PARTICLE_SYSTEMSSEFMA_H_
...
#include <ngl/Vec3.h>
class ParticleSystemSSEFMA
{

  public :
    ParticleSystemSSEFMA(size_t numParticles,ngl::Vec3 _pos);
    ~ParticleSystemSSEFMA();
