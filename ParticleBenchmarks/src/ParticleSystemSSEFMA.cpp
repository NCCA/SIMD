...
ParticleSystemSSEFMA::~ParticleSystemSSEFMA()
{
...
void ParticleSystemSSEFMA::setDefaults()
{
  size_t i;
...
void ParticleSystemSSEFMA::setNumParticles(size_t _numParticles)
{
...
void ParticleSystemSSEFMA::update(float _elapsed)
{
...
void ParticleSystemSSEFMA::setParticleDefaults(size_t particleIndex)
{
  ngl::Random *rng=ngl::Random::instance();
...
void ParticleSystemSSEFMA::render()
{
 ...
 void ParticleSystemSSEFMA::updatePosition(float _dx, float _dy, float _dz)
 {
    m_pos.m_x+=_dx;
    m_pos.m_y+=_dy;
    m_pos.m_z+=_dz;
