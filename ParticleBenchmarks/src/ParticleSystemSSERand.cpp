...
void ParticleSystemSSERAND::setDefaults()
{
  ...
  for (i = 0; i < m_numParticles - remaining_particles; i+=4)
  {
    ...
    store4f(&m_particles->m_energy[ i ],frng::randomFloatSSE(0.0f,1.0f));
  ...
  if ( remaining_particles!=0)
  {
    ...
    storeu4f(&m_particles->m_energy[i],frng::randomFloatSSE(0.0f,1.0f));
...
void ParticleSystemSSERAND::setParticleDefaults(size_t particleIndex)
{
  ...
  m_particles->m_energy[particleIndex]  = frng::randomFloat(0.0f,1.0f);
